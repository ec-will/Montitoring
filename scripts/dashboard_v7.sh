...
# EarthCast HPC System Dashboard v7
# Fixed "Next Run" logic for hourly jobs
...
echo ""
echo "Auto-refresh: watch -c -n 30 $HOME/monitoring/scripts/dashboard_v7.sh"
