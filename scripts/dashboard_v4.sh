...
# EarthCast HPC System Dashboard v4
# Fixed ASCII compatibility - no special box characters
...
# Show empty lines if less than 5 jobs
...
echo ""
echo "Auto-refresh: watch -c -n 30 $HOME/monitoring/scripts/dashboard_v4.sh"
